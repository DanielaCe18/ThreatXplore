...
"""
    ...
    if store_exploit_response.status_code == 200:
        ...
        return False, "Failed to store exploit"
    ...
    if view_exploit_response.status_code == 200:
        ...
        return False, "Failed to view exploit"
...
def main():
    ...
    result, message = check_csrf_vulnerability(url_to_check)
